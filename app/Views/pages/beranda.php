...
<script>
    ...
    $('.filter-checkbox').change(function() {
        ...
        filteredData.forEach(function(item) {
            ...
            html += '<h6 id="news-title" class="text-center font-barlow font-weight-bold">' + item.judul + '</h6>';
            html += '<p id="news-text" class="card-text limited-text font-barlow">' + item.deskripsi + '</p>';
