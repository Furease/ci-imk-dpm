...
<div id="main-context">
    ...
    <div class="container-fluid">
                ...
                <div class="card-header">
                    <button class="btn bg-warning rounded-pill w-75" type="button" data-toggle="collapse" data-target="#visi" aria-expanded="false" aria-controls="visi">
                        <div class="row justify-content-around align-items-center">
                            ...
                            <div class="col-sm-auto text-white h5 mb-0 p-0 ml-2 mr-auto">
                                Visi dan Misi
                            </div>
                      ...
                      <div class="card mx-auto" style="width: fit-content">
                        <div class="card-body text-center">
                          <img class="photo-person"
                            src="https://dpm.stis.ac.id/assets/img/struktur/M. Riza Fakhrulrizqi.jpg"
                            alt="foto ketua dpm" />
                        </div>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="card mx-auto" style="width: fit-content">
                        <div class="card-body text-center">
                          <img class="photo-person"
                            src="https://dpm.stis.ac.id/assets/img/struktur/Alwan Rahmana Subian.jpg"
                            alt="foto wakil ketua dpm" />
                        </div>
                        <div class="popup-footer">
                          <div class="mx-2">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="row justify-content-around">
                        <div class="card mb-1">
                          <div class="card-body text-center">
                            <img class="photo-person"
                              src="https://dpm.stis.ac.id/assets/img/struktur/Wafi Aulia Tsabitah.jpg"
                              alt="foto sekretaris dpm" />
                          </div>
                          <div class="popup-footer">
                            <div class="mx-2">
                        ...
                        <div class="card mb-1">
                          <div class="card-body text-center">
                            <img class="photo-person" src="https://dpm.stis.ac.id/assets/img/struktur/Aulia Azzahra.jpg"
                              alt="foto sekretaris dpm" />
                          </div>
                          <div class="popup-footer">
                            <div class="mx-2">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="row justify-content-around">
                        <div class="card">
                          <div class="card-body text-center">
                            <img class="photo-person"
                              src="https://dpm.stis.ac.id/assets/img/struktur/Faradilla Chairin Ninda.jpg"
                              alt="foto bendahara dpm" />
                          </div>
                          <div class="popup-footer">
                            <div class="mx-2">
                        ...
                        <div class="card mb-1">
                          <div class="card-body text-center">
                            <img class="photo-person"
                              src="https://dpm.stis.ac.id/assets/img/struktur/Adinda Batrisyibazla.jpg"
                              alt="foto bendahara dpm" />
                          </div>
                          <div class="popup-footer">
                            <div class="mx-2">
                      ...
                      <div>
                        <div class="row justify-content-around mx-5">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/La Ode Farhan Rezka.jpg"
                                alt="foto anggota komisi 1" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Muhammad Afnan Alfian.jpg"
                                alt="foto anggota komisi 1" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person" src="https://dpm.stis.ac.id/assets/img/struktur/Muhammad.jpg"
                                alt="foto anggota komisi 1" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Chainur Ar Rasyid.jpg"
                                alt="foto anggota komisi 1" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Muhammad Rafii Al Muflih.jpg"
                                alt="foto anggota komisi 1" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Gilang Wahyu Prasetyo.jpg"
                                alt="foto anggota komisi 1" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Adham Malay Japany.jpg"
                                alt="foto anggota komisi 1" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Viery Zanki Kurniaffandi.jpg"
                                alt="foto anggota komisi 1" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Muhammad Yusuf Naufal.jpg"
                                alt="foto anggota komisi 1" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Albert Assidiq.jpg"
                                alt="foto anggota komisi 1" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
        ...
        <!-- Modal Komisi 2 -->
        <div class="modal fade" id="modalKomisiDua" tabindex="-1" role="dialog"
                aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                <div class="modal-dialog " role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="d-flex justify-content-center ">
                        <div class="card mb-1">
                          <div class="card-body text-center">
                            <img class="photo-person"
                              src="https://dpm.stis.ac.id/assets/img/struktur/Abdul Azis Daffa Yanuar.jpg"
                              alt="foto ketua komisi 2" />
                          </div>
                          <div class="popup-footer">
                            <div class="mx-2">
                      ...
                      <div>
                        <div class="row justify-content-around mx-5">
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Muh. Nur Afrizal.jpg"
                                alt="foto anggota komisi 2" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Yoga Regita Hamzah Ashari.jpg"
                                alt="foto anggota komisi 2" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Reynadi Wisnu Wardana.jpg"
                                alt="foto anggota komisi 2" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Ahmad Excell Ramadhan.jpg"
                                alt="foto anggota komisi 2" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Yoga Pratama.jpg"
                                alt="foto anggota komisi 2" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Maulana Kusuma Ramadhan.jpg"
                                alt="foto anggota komisi 2" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Angga Prayoga.jpg"
                                alt="foto anggota komisi 2" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Muhammad ‘Anil ‘Aziz.jpg"
                                alt="foto anggota komisi 2" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Ainul Baharuddin.jpg"
                                alt="foto anggota komisi 2" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Steven Fitraeka Setiawan Sanjaya.jpg"
                                alt="foto anggota komisi 2" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Ahmad Aulia Rahman.jpg"
                                alt="foto anggota komisi 2" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Akhir Mubarok.jpg"
                                alt="foto anggota komisi 2" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Rifki Arya Farezi.jpg"
                                alt="foto anggota komisi 2" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Rasya Khalil Gibran.jpg"
                                alt="foto anggota komisi 2" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
        ...
        <div class="modal fade" id="modalKomisiDua" tabindex="-1" role="dialog"
              ...
              <!-- Modal Komisi 3 -->
              <div class="modal fade" id="modalKomisiTiga" tabindex="-1" role="dialog"
                aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                <div class="modal-dialog " role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="d-flex justify-content-center">
                        <div class="card mb-1">
                          <div class="card-body text-center">
                            <img class="photo-person"
                              src="https://dpm.stis.ac.id/assets/img/struktur/Ade Rifqy Setyawan.jpg"
                              alt="foto ketua komisi 3" />
                          </div>
                          <div class="popup-footer">
                            <div class="mx-2">
                      ...
                      <div>
                        <div class="row justify-content-around mx-5">
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Rizky Alif Ichwanto.jpg"
                                alt="foto anggota komisi 3" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Rizal Dwi Syahputra.jpg"
                                alt="foto anggota komisi 3" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Rahmat Hidayat.jpg"
                                alt="foto anggota komisi 3" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person" src="https://dpm.stis.ac.id/assets/img/struktur/Revi.jpg"
                                alt="foto anggota komisi 3" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Rangga Amriz Sahputra.jpg"
                                alt="foto anggota komisi 3" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Yudika Haris Solihin.jpg"
                                alt="foto anggota komisi 3" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Dhymas Adhyza Rayhan.jpg"
                                alt="foto anggota komisi 3" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Halim Nur Jamaluddin.jpg"
                                alt="foto anggota komisi 3" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Wildhan Surya Putra.jpg"
                                alt="foto anggota komisi 3" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Muhammad Geraldi Yosandri.jpg"
                                alt="foto anggota komisi 3" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Dicky Ferdiansya.jpg"
                                alt="foto anggota komisi 3" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Muhammad Azhari.jpg"
                                alt="foto anggota komisi 3" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Syaikhul Ibad.jpg"
                                alt="foto anggota komisi 3" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Farchany Achmad.jpg"
                                alt="foto anggota komisi 3" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Ilham Arya Dhuta Zain.jpg"
                                alt="foto anggota komisi 3" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
              ...
              <!-- Modal Komisi 4 -->
              <div class="modal fade" id="modalKomisiEmpat" tabindex="-1" role="dialog"
                aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                <div class="modal-dialog " role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="card mb-1">
                        <div class="card-body text-center">
                          <img class="photo-person" src="https://dpm.stis.ac.id/assets/img/struktur/Saifullah Fatah.jpg"
                            alt="foto ketua komisi 4" />
                        </div>
                        <div class="popup-footer">
                          <div class="mx-2">
                      ...
                      <div>
                        <div class="row justify-content-around mx-5">
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Anggra Dwi Prasetya.jpg"
                                alt="foto anggota komisi 4" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Ahmad Wahyu Febrian.jpg"
                                alt="foto anggota komisi 4" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Berniko Surya Wibawa.jpg"
                                alt="foto anggota komisi 4" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Fajar Malik Noor Ahmad.jpg"
                                alt="foto anggota komisi 4" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Feza Raffa Arnanda.jpg"
                                alt="foto anggota komisi 4" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Rafael Agintha Tarigan.jpg"
                                alt="foto anggota komisi 4" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Mayrlan Rante Palalangan.jpg"
                                alt="foto anggota komisi 4" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Aulia Rahman.jpg"
                                alt="foto anggota komisi 4" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Muhammad Reyhan Fadhilla.jpg"
                                alt="foto anggota komisi 4" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Aldi Firmansyah.jpg"
                                alt="foto anggota komisi 4" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Haryuningtyas Ramadhani Putri.jpg"
                                alt="foto anggota komisi 4" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
                          ...
                          <div class="card mb-2">
                            <div class="card-body text-center">
                              <img class="photo-person"
                                src="https://dpm.stis.ac.id/assets/img/struktur/Billy Aufa Alfarisy.jpg"
                                alt="foto anggota komisi 4" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
              ...
              <!-- Modal HPD -->
              <div class="modal fade" id="modalHpd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
                aria-hidden="true">
                <div class="modal-dialog " role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="row">
                          <div class="card mx-auto">
                            <div class="card-body text-center">
                              ...
                              <img class="photo-person" src="https://dpm.stis.ac.id/assets/img/struktur/default-img.png"
                                alt="foto ketua dpm" />
                            </div>
                            <div class="popup-footer">
                              <div class="mx-2">
              ...
              <!-- Modal IT -->
              <div class="modal fade" id="modalIt" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
                aria-hidden="true">
                <div class="modal-dialog " role="document">
                  <div class="modal-content">
                    <div class="modal-header">
